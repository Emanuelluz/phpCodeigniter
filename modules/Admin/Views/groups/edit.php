                            ...
                            <div class="card">
                                <div class="card-header bg-white">
                                    <h5 class="card-title mb-0">
                                        ...
                                        Editar Grupo: <?= esc($group['title']) ?>
                                    </h5>
                                </div>
                                
                                <?= form_open('/admin/groups/update/' . urlencode($group['name']), ['class' => 'needs-validation', 'novalidate' => true]) ?>
                                <div class="card-body">
                                    <!-- Alerts -->
                                        ...
                                        <div class="col-md-12">
                                            <div class="card bg-light">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <small class="text-muted">Nome do Grupo:</small>
                                                            <div class="fw-bold"><?= esc($group['name']) ?></div>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <small class="text-muted">Criado por:</small>
                                                            <div class="fw-bold">Sistema Shield</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control <?= session('errors.description') ? 'is-invalid' : '' ?>" 
                                                  ...
                                                  name="description" 
                                                  rows="3"
                                                  placeholder="Descreva o propósito deste grupo..."><?= old('description', $group['description']) ?></textarea>
                                        <div class="invalid-feedback">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="card border-light">
                                            <div class="card-body">
                                                ...
                                                <?php else: ?>
                                                    <div class="row">
                                                        <?php foreach ($all_permissions as $permission => $description): ?>
                                                            ...
                                                            <div class="permission-item">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" 
                                                                           ...
                                                                           <?= in_array($permission, old('permissions', $group_permissions)) ? 'checked' : '' ?>>
                                    ...
                                    <!-- Warning for system groups -->
                                    <?php if (in_array($group['name'], ['admin', 'superadmin', 'user'])): ?>
                                    <div class="alert alert-warning">
                                        <i class="bi bi-exclamation-triangle me-2"></i>
                                        <strong>Atenção:</strong> Este é um grupo do sistema. Alterações podem afetar funcionalidades críticas.
                                    </div>
                                    <?php endif; ?>
                                </div>

                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            ...
                            <div class="card">
                                ...
                                <?= form_open('/admin/users/store', ['class' => 'needs-validation', 'novalidate' => true]) ?>
                                <div class="card-body">
                                    <!-- Alerts -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="password" 
                                                   ...
                                                   required>
                                            <div class="invalid-feedback">
                                                <?= session('errors.password_confirm') ?? 'Confirme a senha' ?>
                                            </div>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="col-md-4 mb-2">
                                                            <div class="form-check">
                                                                <input class="form-check-input" 
                                                                       ...
                                                                       value="<?= esc($group) ?>" 
                                                                       id="group_<?= esc($group) ?>"
                                                                       <?= in_array($group, old('groups', [])) ? 'checked' : '' ?>>
                                    ...
                                    <div class="mb-3">
                                        <div class="form-check form-switch">
                                            ...
                                            <label class="form-check-label" for="active">
                                                ...
                                                <div class="form-text">Usuário pode fazer login no sistema</div>
                                            </label>
                                        </div>
                                    </div>
                                </div>

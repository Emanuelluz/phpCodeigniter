...
class AuthController extends BaseController
{
    ...
    public function doLogin(): RedirectResponse
    {
        ...
        log_message('info', 'AuthController::doLogin - Login bem-sucedido. Redirecionando para /sso/admin');

        // Redireciona ao dashboard SSO após login
        return redirect()->to('/sso/admin')->with('success', 'Login realizado com sucesso!');
    }
